...
基于 **CARLA 0.9.16** 实现作业一：在 CARLA 中生成无人车，通过键盘实时控制其运动，
并用前视相机 + pygame 显示车头画面。可在 **Windows 原生** 或 **Ubuntu 20.04 / 22.04**
运行，提供 ROS1 Noetic / ROS2 Humble launch 封装。
...
- 依赖：见 `requirements.txt`（numpy / opencv / pygame）
...
# ROS2 Humble
ros2 launch carla_assignment 01_control_launch.py mode:=test
