...
* 激光雷达 `lidar1`：6329–6343 点，ENU 包围盒 `x∈[-87.0, 92.4] y∈[-23.2, 93.8] z∈[-29.45, -4.75]`；
  此时机体位于 ENU `(0.05, -0.05, -29.25)`，即**贴地悬停**（地面 `z=-29.45`，建筑顶部到 `z=-4.75`），
  到机体距离最近 1.51 m、最远 100.00 m、中位数 3.28 m
